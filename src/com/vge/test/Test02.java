...
/*        Student s = studentDao.select1("001");
        ...
        //查询出所有年龄为23岁的学员的详细信息
/*        List<Student> sList = studentDao.select2(17);
        for(Student s:sList){
            System.out.println(s);
        }*/

        //3.测试：parameterType
        //需求：查询出姓名为xiaohong，年龄为17岁的学员信息
        /*
         ...
         */
        /*
        List<Student> sList = studentDao.select3("xiaohong",17);
        for(Student s:sList){
            System.out.println(s);
        }*/
        ...
        */
        ...
        /*
            ...
            总结：
                ...
                需求：请查询出 姓名为xiaohong，班级为一年一班的学员的详细信息
                ...
                *
                ...
                where s.name=#{xiaohong} and c.name=#{一年一班}
        ...
        */
        ...
        // 这种情况不多见
/*        Student s = studentDao.select6("008");
        System.out.println(s);*/

        //7.测试：like模糊查询 方式1：使用${} 了解
/*        List<Student> sList = studentDao.select7("h");
        for(Student s1:sList){
            System.out.println(s1);
        }*/

        //8.测试：like模糊查询 方式2：使用#{} 了解
/*        List<Student> sList = studentDao.select8("%h%");
        for(Student s1:sList){
            System.out.println(s1);
        }*/

        //9.测试：like模糊查询 方式3：使用#{} 掌握
/*        List<Student> sList = studentDao.select9("h");
        for(Student s1:sList){
            System.out.println(s1);
        }*/
        ...
        //需求：查询出编号为001的学员的姓名
/*        String name = studentDao.select10("001");
...
/*        List<String> sList = studentDao.select11();
        ...
        */
        ...
        //15.测试 resultType 当数据库表字段名称和domain类属性名称不一致时的处理
        // 方式1：起别名
...
/*        List<Student> sList = studentDao.select16();
        ...
        // list集合用来从sql语句中取出数据并封装好之后，供前端展示用的
        // 前端往后端传参数用数组

        //18.测试:动态sql foreach标签
        //查询编号为001,002,003的学员信息
     /*   String strArr[] = {"001","002","003"};
        ...
        //19.测试:sql片段
/*        Student s = studentDao.select19("001");
        System.out.println(s);*/
     ...
     /*   List<StudentAndClassroomVo> voList = studentDao.select21();
        ...
        List<StudentAndClassroomVo> voList = studentDao.select22("y");
        for (StudentAndClassroomVo vo : voList) {
